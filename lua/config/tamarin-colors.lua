...
function M.setup()
  ...
  M.highlights = {
    ...
    ---------------------------------------------------
    ["@operator"]                          = colors.pink,              -- Action brackets: --[ and ]->
    ["@operator.assignment"]               = colors.slateGrayPlain,    -- Assignment operators: = in let statements
    ["@punctuation.square_bracket"]        = colors.slateGrayPlain,    -- Regular brackets: (), [], <>
    ["@tuple"]                             = colors.goldBold,          -- Regular brackets: (), [], <>
    ["@punctuation.round_bracket"]         = colors.slateGrayPlain,    -- Regular brackets: (), [], <>
    ["@punctuation.delimiter_sans_period"] = colors.slateGrayBold,     -- Punctuation: ,;: (but no fullstop)
    ["@punctuation.delimiter.period"]      = colors.slateGrayBold,     -- Punctuation: . (just the fullstop)
    ...
    ["@operator.implies"]                  = colors.slateGrayBold,     -- Logical operator: ==>
    ["@operator.at"]                       = colors.slateGrayBold,     -- At operator: @
